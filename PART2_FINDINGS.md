...
statement (SEC form DEF 14A) for each meeting year 2016–2024 — 450 filings, 100% recovered.
...
vocabulary rather than trading one for the other — a meaningfully different picture from
...
reckoning, and the 2021 ExxonMobil climate proxy fight — though not every event left a mark.
...
filings so the time series stays continuous. Nine companies had a "collision" — more than
one candidate filing in a year, almost always a shareholder-activist contest where the
...
budge (−0%) and stayed the **most prominent** theme every single year. The plausible reason
...
That said, the *framing* did shift even where the word-counts didn't. An independent
...
- **The 2022–23 anti-ESG backlash** coincides with diversity language going *flat* (consistent
...
consumer/tech firms shifting toward **diversity & inclusion** in the 2020s — the same
...
- **Keyword frequency ≠ sincerity.** Rising environmental wording measures emphasis, not
  action — measuring the gap to action is the whole point of the later parts.
